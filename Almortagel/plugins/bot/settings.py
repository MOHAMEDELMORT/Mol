...
from Almortagel.utils.decorators.admins import ActualAdminCB
from Almortagel.utils.decorators.language import language, languageCB
from Almortagel.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from Almortagel.utils.inline.start import private_panel
...
close_button = InlineKeyboardButton("「 تنظيف 」", callback_data="close")
