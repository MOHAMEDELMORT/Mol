...
htxt = [
" لو بنت هاجي غير كدة لا 🙄😂"
        ]

@app.on_message(filters.command(["تعالي خاص"], ""), group=273)
...
@app.on_message(filters.command(["سيفي"], ""), group=22703)
