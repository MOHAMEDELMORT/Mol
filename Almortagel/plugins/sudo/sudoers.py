...
from Almortagel.utils.database import add_sudo, remove_sudo
from Almortagel.utils.decorators.language import language
from Almortagel.utils.extraction import extract_user
...
@app.on_message(filters.command(["المنشئين", "المنشئيين", "sudoers"]) & ~BANNED_USERS)
