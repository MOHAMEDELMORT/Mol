...
def first_page(_):
	controll_button = [InlineKeyboardButton(text="", callback_data=f"Adisa"), InlineKeyboardButton(text="‹ الرئيسية › ", callback_data=f"settingsback_helper"), InlineKeyboardButton(text="‹ التالي ›", callback_data=f"dilXaditi")]
