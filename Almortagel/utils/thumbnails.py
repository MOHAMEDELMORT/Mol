...
async def get_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"Almortagel/assets/Almortagel.png")
        ...
        font = ImageFont.truetype("Almortagel/assets/font2.ttf", 45)
        ImageFont.truetype("Almortagel/assets/font2.ttf", 70)
        arial = ImageFont.truetype("Almortagel/assets/font2.ttf", 30)
        ImageFont.truetype("Almortagel/assets/font.ttf", 30)
