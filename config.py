...
Mortagel = getenv("mortagel", "AlmortagelTech")
...
BOT_USERNAME = getenv("BOT_USERNAME" , "Almortagel_music_bot")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/MOHAMEDELMORT/Alm",
)
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/AlmortagelTech2")
